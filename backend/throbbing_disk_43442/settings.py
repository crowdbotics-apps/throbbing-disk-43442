"""
Django settings for throbbing_disk_43442 project.
...
ROOT_URLCONF = 'throbbing_disk_43442.urls'
...
WSGI_APPLICATION = 'throbbing_disk_43442.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_disk_43442 API",
    "DESCRIPTION": "API documentation for throbbing_disk_43442 App",
    "VERSION": "v1",
}
